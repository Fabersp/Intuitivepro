...
@interface SSPopup_Amarelo : UIControl<UITableViewDataSource,UITableViewDelegate>
{
...
@property (nonatomic, assign) id<SSPopupDelegate> SSPopup_AmareloDelegate;
