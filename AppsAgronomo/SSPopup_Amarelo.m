...
@end
@implementation SSPopup_Amarelo
...
- (id)initWithFrame:(CGRect)frame delegate:(id<SSPopupDelegate>)delegate
{
    ...
    {
        self.SSPopup_AmareloDelegate = delegate;
    }
...
- (nullable UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    [myview setBackgroundColor:[UIColor colorWithRed:255/255.0 green:199/255.0 blue:0/255.0 alpha:1]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath;
{
    ...
    Contentlbl.textColor = [UIColor colorWithRed:255/255.0 green:199/255.0 blue:0/255.0 alpha:1];
...
//    
    ...
    if ([self.SSPopup_AmareloDelegate respondsToSelector:@selector(GetSelectedOutlet:)]) {
        
        [self.SSPopup_AmareloDelegate GetSelectedOutlet:(int)indexPath.row];
    }
