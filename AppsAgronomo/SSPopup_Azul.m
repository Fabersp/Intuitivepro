...
- (id)initWithFrame:(CGRect)frame delegate:(id<SSPopupDelegate>)delegate
{
    ...
    {
        self.SSPopup_AzulDelegate = delegate;
    }
...
- (nullable UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    [myview setBackgroundColor:[UIColor colorWithRed:3/255.0 green:169/255.0 blue:244/255.0 alpha:1]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath;
{
    ...
    Contentlbl.textColor = [UIColor colorWithRed:3/255.0 green:169/255.0 blue:244/255.0 alpha:1];
...
//    
    ...
    if ([self.SSPopup_AzulDelegate respondsToSelector:@selector(GetSelectedOutlet:)]) {
        
        [self.SSPopup_AzulDelegate GetSelectedOutlet:(int)indexPath.row];
    }
