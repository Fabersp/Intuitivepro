...
- (id)initWithFrame:(CGRect)frame delegate:(id<SSPopupDelegate>)delegate
{
    ...
    {
        self.SSPopup_VerdeDelegate = delegate;
    }
...
- (nullable UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    [myview setBackgroundColor:[UIColor colorWithRed:26/255.0 green:188/255.0 blue:156/255.0 alpha:1]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath;
{
    ...
    Contentlbl.textColor = [UIColor colorWithRed:26/255.0 green:188/255.0 blue:156/255.0 alpha:1];
...
//    
    ...
    if ([self.SSPopup_VerdeDelegate respondsToSelector:@selector(GetSelectedOutlet:)]) {
        
        [self.SSPopup_VerdeDelegate GetSelectedOutlet:(int)indexPath.row];
    }
