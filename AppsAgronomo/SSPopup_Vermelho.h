...
@interface SSPopup_Vermelho : UIControl<UITableViewDataSource,UITableViewDelegate>
{
...
@property (nonatomic, assign) id<SSPopupDelegate> SSPopup_VermelhoDelegate;
