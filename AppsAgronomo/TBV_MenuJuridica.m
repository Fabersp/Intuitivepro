...
@interface TBV_MenuJuridica ()

@end

@implementation TBV_MenuJuridica
...
- (void)viewDidLoad {
    ...
    self.navigationController.navigationBar.barTintColor = vermelho;
...
-(void)Loading {
    if (internetActive){
        ...
        NSString * urlStr = @"http://www.promastersolution.com.br/guia/api/lista_categoria.php?tipo_os=IOS&categ=3&id_cidade=2301";
...
- (IBAction)btnBuscar:(id)sender {
    ...
    clientes.vcCor = vermelho;
    clientes.vsCodCor = @"3";
    clientes.vsIdCategoria = @"3";
