...
@interface tv_clientes_especialistas ()

@end

@implementation tv_clientes_especialistas
...
-(void)Loading {
    if (internetActive){
        ...
        NSString * porPlano = [NSString stringWithFormat:@"http://www.promastersolution.com.br/guia/api/lista_clientes_espec_plano.php?tipo_os=IOS&espec=%@&conv=%@&categ=%@", vsIdEspecialista, vsIdPlano, vsIdCategoria];
        
        
        NSString * porGeral = [NSString stringWithFormat:@"http://www.promastersolution.com.br/guia/api/lista_clientes_especializacao.php?tipo_os=IOS&espec=%@&categ=%@", vsIdEspecialista, vsIdCategoria];
        
        if ([vsIdPlano  isEqual: @""])
